...
Before you can create your site, you must [download this repository](https://github.com/vaibhavhariaramani/Portfolio-template-2/archive/master.zip) for your site on GitHub. 

On GitHub,make your repository is created by navigating to your site's repository.

## step 3: Making Changes to Template
open your portfolio-template Directory which you have downloaded in previous step in [Visual Studio Code Editor](https://code.visualstudio.com/download) or in Your Favourite Editor.
